...
def gettypes( course ): return course['Type']
def getlocations( course ): return course['Location']
def gettimes( course ): return course['Times']
def getsection( course ): return course['Section'][0].strip()
def getprofessor( course ): return course['Instructor'][0]
def getavail( course ):   return course['Avail'][0]
